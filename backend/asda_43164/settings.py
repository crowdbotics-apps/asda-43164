"""
Django settings for asda_43164 project.
...
WSGI_APPLICATION = 'asda_43164.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asda_43164 API",
    "DESCRIPTION": "API documentation for asda_43164 App",
    "VERSION": "v1",
}
